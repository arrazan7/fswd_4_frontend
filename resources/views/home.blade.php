...
<html lang="en">
    ...
    <body class="font-poppins">
        <nav
            class="flex justify-between px-20 py-4 shadow-md fixed top-0 left-0 right-0 z-[2] bg-white"
        >
            <a href="https://atourin.com/" target="_blank"
                ><svg
                    data-v-05599172=""
                    id="color"
                    xmlns="http://www.w3.org/2000/svg"
                    height="40px"
                    viewBox="0 0 145.55 39.37"
                >
                    ...
                    <g data-v-05599172="" fill="#a855f7" stroke="none">
                        <path
                            data-v-05599172=""
                            d="M26.46,24.67l-.02,.02c.39-.46,.75-.94,1.07-1.43l-1.06,1.41h0Z"
                        ></path>
                        <path
                            data-v-05599172=""
            ...
            <div class="flex justify-end items-center">
                <a
                    class="flex items-center mr-14"
                    href="https://atourin.com/explore/itinerary"
                    target="_blank"
                >
                    <svg
                        data-v-05599172=""
                    ...
                    <span class="text-base text-slate-600 font-semibold ml-2"
                        >Destinasi</span
                    >
                </a>
                <a
                    class="flex items-center mr-14"
                    href="https://atourin.com/itinerary-editor"
                    target="_blank"
                >
                    <svg
                        data-v-05599172=""
                ...
                <a href="{{ route('profile') }}">
                    <img
                        src="http://127.0.0.1:8000/storage/profile/{{ $profile['photo'] }}"
        ...
        <div class="relative">
            <img
                src="http://127.0.0.1:8000/storage/web/img_home.jpg"
                class="w-screen h-screen object-cover brightness-50"
            />
            <p
                class="absolute top-1/2 left-1/2 -translate-x-1/2 z-[1] text-3xl font-semibold text-white text-center"
            >
        ...
        <div class="max-w-[1200px] mx-auto">
            <p
                class="text-3xl text-purple-800 text-center font-semibold py-5 mt-20"
            >
                Paket Wisata Atourin
            </p>
            <div>
                <form
                    action="{{ route('filter_travel') }}"
                    method="POST"
                ...
                >
                    ...
                    <div class="relative inline-block">
                        ...
                        >
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="lokasi1"
                                name="lokasi1" value="Yogyakarta" class="mt-px
                                mr-1" multiple
                                {{
                                    in_array("Yogyakarta", $filter["lokasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="lokasi2"
                                name="lokasi2" value="Jakarta" class="mt-px
                                mr-1" multiple
                                {{
                                    in_array("Jakarta", $filter["lokasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="lokasi3"
                                name="lokasi3" value="Surakarta" class="mt-px
                                mr-1" multiple
                                {{
                                    in_array("Surakarta", $filter["lokasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="lokasi4"
                                name="lokasi4" value="Surabaya" class="mt-px
                                mr-1" multiple
                                {{
                                    in_array("Surabaya", $filter["lokasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="lokasi5"
                                name="lokasi5" value="Bandung" class="mt-px
                                mr-1" multiple
                                {{
                                    in_array("Bandung", $filter["lokasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div class="flex justify-center py-3 px-4">
                                <button
                                    type="button"
                                    class="px-2 py-1 text-base text-slate-700"
                    ...
                    <div class="relative inline-block">
                        ...
                        >
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="harga1" name="harga1"
                                value="1" class="mt-px mr-1" multiple
                                {{
                                    in_array(1, $filter["harga"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="harga2" name="harga2"
                                value="2" class="mt-px mr-1" multiple
                                {{
                                    in_array(2, $filter["harga"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="harga3" name="harga3"
                                value="3" class="mt-px mr-1" multiple
                                {{
                                    in_array(3, $filter["harga"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                                <label for="harga3"
                                    >Rp150.001 - Rp300.000</label
                                >
                            </div>
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="harga4" name="harga4"
                                value="4" class="mt-px mr-1" multiple
                                {{
                                    in_array(4, $filter["harga"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                                <label for="harga4"
                                    >Rp300.001 - Rp500.000</label
                                >
                            </div>
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="harga5" name="harga5"
                                value="5" class="mt-px mr-1" multiple
                                {{
                                    in_array(5, $filter["harga"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                    ...
                    <div class="relative inline-block">
                        ...
                        >
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi1"
                                name="durasi1" value="1" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(1, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi2"
                                name="durasi2" value="2" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(2, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi3"
                                name="durasi3" value="3" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(3, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi4"
                                name="durasi4" value="4" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(4, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi5"
                                name="durasi5" value="5" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(5, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi6"
                                name="durasi6" value="6" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(6, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                            ...
                            <div
                                class="flex items-center py-3 px-4 border-b hover:bg-slate-300"
                            >
                                <input type="checkbox" id="durasi7"
                                name="durasi7" value="7" class="mt-px mr-1"
                                multiple
                                {{
                                    in_array(7, $filter["durasi"])
                                        ? "checked"
                                        : ""
                                }}
                                />
                ...
                @endif
                    <div class="rounded-lg">
                        ...
                        <div class="text-right">
                            <p
                                class="inline-block py-1 px-2 bg-purple-800 rounded-lg text-white"
                            >
        ...
        <script
            src="https://kit.fontawesome.com/1fe05764da.js"
