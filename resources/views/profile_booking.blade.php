...
<html lang="en">
    ...
    <body class="font-poppins">
        <nav
            class="flex justify-between px-20 py-4 shadow-md fixed top-0 left-0 right-0 z-[1] bg-white"
        >
        ...
        <div class="max-w-[1100px] mx-auto mt-24 grid grid-cols-12 gap-5">
            <div
                class="col-span-3 flex flex-col items-center rounded-lg shadow-lg h-fit"
            >
                <img
                    src="http://127.0.0.1:8000/storage/web/profile_dummy.png"
                    class="w-40 h-40 object-cover object-center rounded-full my-10"
                />
                <p
                    class="text-lg font-semibold text-slate-800 whitespace-nowrap w-52 overflow-hidden text-ellipsis"
                >
                    Fayyadh Arrazan Miftakhul
                </p>
                <div class="flex flex-col w-full py-9">
                    <a
                        class="px-7 py-2 text-sm border-l-4 text-slate-800 border-transparent"
                        >Pengaturan Profile</a
                    >
                    <a
                        class="px-7 py-2 text-sm border-l-4 text-purple-500 border-purple-500"
                        >Pemesanan Saya</a
                    >
                </div>
                <button
                    class="text-lg text-white font-semibold bg-red-600 rounded-lg py-2 px-3 mb-10"
                >
                    Logout
                </button>
            </div>
            <div
                class="col-span-9 rounded-lg shadow-lg h-fit flex flex-col p-8"
            >
                <table
                ...
                >
                    <thead>
                        <tr>
                            <th
                                class="border border-slate-600 bg-purple-500 text-white"
                            >
                                No
                            </th>
                            <th
                    ...
                    <tbody class="text-center">
                        <tr>
                            ...
                            <td class="border border-slate-700">
                                <div class="flex justify-center items-center">
                                    <a href="" title="Batalkan Pemesanan"
                                        ><i
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-700">3</td>
                            <td class="border border-slate-700">200000</td>
                            <td class="border border-slate-700">
                                <div class="flex justify-center items-center">
                                    <a href="" title="Batalkan Pemesanan"
                                        ><i
