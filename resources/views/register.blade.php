...
<html lang="en">
    ...
    <body
        class="flex w-screen h-screen items-center justify-center font-poppins"
    >
        <img
            src="http://127.0.0.1:8000/storage/web/bg_register.jpg"
        ...
        <div class="flex justify-between w-9/12 h-5/6 px-6 mt-5">
            ...
            <div
                class="w-5/12 h-full border rounded-xl shadow-md overflow-hidden"
            >
                <div class="h-full bg-white p-10">
                    <p
                        class="text-2xl font-semibold text-center text-slate-800 mb-10"
                    >
                        Daftar Akun
                    </p>
                    @if (Session::has('success'))
                        <p class="text-center text-lg text-green-500 bg-green-200 border border-green-400 rounded-lg py-2 px-3 mb-5 -mt-5">
                            {{ Session::get('success') }}
                        </p>
                    @endif

                    @if (Session::has('error'))
                        <p class="text-center text-lg text-pink-500 bg-pink-200 border border-pink-400 rounded-lg py-2 px-3 mb-5 -mt-5">
                            {{ Session::get('error') }}
                        </p>
                    @endif
                    ...
                    @csrf
                        ...
                        <p class="mb-4 text-sm text-center text-slate-800">
                            ...
                            <span class="text-purple-500"
                                ><a
                                    href="https://atourin.com/privacy"
                                    target="_blank"
                                    >Kebijakan Privasi</a
                                ></span
                            >
