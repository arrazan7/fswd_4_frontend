        ...
        <div class="max-w-[700px] mx-auto mt-32 p-10 border border-purple-500">
            ...
            <form action="{{ route('booking') }}" method="POST">
                ...
                <input
                    ...
                    value="{{ $id_travel }}"
                />
                <label for="tanggal" class="block text-base text-slate-500"
                ...
                />
                <label for="tiket" class="block text-base text-slate-500"
                    >Jumlah Tiket:</label
                >
                <input
                    type="number"
